...
def main():
    ...
    func_exec_output_file = os.path.join(resultsDir, args.funcExec_output)

    dev_exec_output_file = os.path.join(resultsDir, args.devExec_output)
    ...
    with open(csv_input_file, newline='') as rf:
        ...
        for raw in csvrdr:
            ...
            if accelEntries: 
                execTimeList.append(ExecTimeEntry('Accel', row))
                continue
